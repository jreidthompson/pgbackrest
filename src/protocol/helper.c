...
protocolRemoteParam(ProtocolStorageType protocolStorageType, unsigned int hostIdx)
{
    ...
    MEM_CONTEXT_TEMP_BEGIN()
    {
        ...
        kvPut(
            ...
            cfgOptionIdxSource(optConfigPath, hostIdx) != cfgSourceDefault ? VARSTR(cfgOptionIdxStr(optConfigPath, hostIdx)) :
            NULL);
        ...
        for (ConfigOption optionId = 0; optionId < CFG_OPTION_TOTAL; optionId++)
        {
            ...
            else
            {
                ...
                {
                    remove =
                        !cfgParseOptionRequired(cfgCommand(), optionId) || cfgParseOptionDefault(cfgCommand(), optionId) != NULL;
                }
